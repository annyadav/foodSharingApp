...
export default function AvailbleFood() {
  ...
  const handleClick = () => {
    confirm(
      "Thank you for trusting us. You will be navigated to home page now..."
    );
    navigate("/");
  };
                      ...
                      <div className="modal-content">
                        ...
                        <div className="modal-body">
                          <p className="text-wrap">
                            You can reach out to the provider at
                            <p>
                              Contact: <i>0896756785</i>
                            </p>
                            <p>
                            Also, the allergen information of a food will be 
                            labelled on the food itself but if in doubt its 
                            better to ask the sharer who listed it.
                            </p>
                          </p>
                        </div>
